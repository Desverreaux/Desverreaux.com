...
<html>
    <head>
        ...
        <style>
        .bgimg-1 {
             background-image: url({{$Image['sad']}});
         }
        </style>
...
<div id="main" class="p-0 my-0" height="10vh">
<!-- First Parallax Image with Logo Text -->
<div class="bgimg-1 w3-display-container" id="home">
    
</div>

<div class="text_container w3-opacity w3-round-xxlarge">
<div padding="30px">
...
<!-- Footer -->
  <div class="w3-xlarge w3-center w3-display-bottommiddle">
