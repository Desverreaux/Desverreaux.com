...
<html lang="{{ config('app.locale') }}">
    <head>
        ...
        <?php //hacky work around to not having a database
...
<div class="bgimg-1 w3-display-container w3-opacity-min " id="home" >
  <div class="w3-display-middle" style="white-space:nowrap;">
    <span class="w3-center w3-padding-large w3-black w3-xlarge w3-wide w3-animate-opacity" >MY <span class="w3-hide-small" z-index="0">WEBSITE</span> LOGO</span>
  </div>
</div>
...
<div class="bgimg-3 w3-display-container w3-opacity-min">
  <div class="w3-display-middle">
     <span class="w3-xxlarge w3-text-white w3-wide">[Section to be defined]</span>
  </div>
</div>
